...
import pl.camp.it.rent.validators.AddressValidator;
...
@RequestMapping(value = "/confirm",method = RequestMethod.POST)
    public String confirmOrder(@ModelAttribute Address address) throws ExecutionControl.NotImplementedException {
    try{
